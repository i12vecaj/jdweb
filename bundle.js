...
const enqueueDebouncer = function enqueueDebouncer(debouncer) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SkApp; });
...
/* harmony import */ var _style_pcss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.pcss */ "./src/components/containers/sk-app/style.pcss");
...
/* harmony import */ var _template_html__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./template.html */ "./src/components/containers/sk-app/template.html");
...
/* harmony import */ var _dumbs_sk_button__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../dumbs/sk-button */ "./src/components/dumbs/sk-button/index.js");




class SkApp extends _polymer_polymer_polymer_element__WEBPACK_IMPORTED_MODULE_0__["PolymerElement"] {
  static get properties() {
    return {
      name: {
        type: String
  ...
  static get template() {
    return Object(_polymer_polymer_polymer_element__WEBPACK_IMPORTED_MODULE_0__["html"])([`<style>${_style_pcss__WEBPACK_IMPORTED_MODULE_1___default.a}</style> ${_template_html__WEBPACK_IMPORTED_MODULE_2___default.a}`]);
  }
  ...
  startTour() {
    window.location.replace('https://es.linkedin.com/in/josedavidvela');
  }
...
module.exports = "a,a:visited{color:#fff;text-decoration:none;font-weight:700;transition:color .2s}p{font-size:1em;color:#fff;line-height:1.8;font-weight:200}@keyframes FadeIn{0%{transform:translateY(5%) scale(.8)}to{transform:none;opacity:1}}:host{display:block;overflow:auto;height:100vh}.Welcome{justify-content:center;align-items:center;display:flex;flex-direction:column;margin-top:10vh;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;cursor:default;position:relative;padding:220px 40px 0;overflow-x:hidden}.Title{font-size:3em;font-weight:800;margin-bottom:40px;opacity:0;animation-delay:.4s;animation-fill-mode:forwards;animation-timing-function:ease-out}.Title,.Welcome p{text-align:center;margin-top:0;animation-name:FadeIn;animation-duration:.4s}.Welcome p{max-width:90%;letter-spacing:2px;opacity:.8;opacity:0;animation-delay:.5s;animation-fill-mode:forwards;animation-timing-function:ease-out}@media (min-width:60em){.Welcome p{max-width:60%}}.Meta{font-size:.5em;opacity:.5;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;cursor:default;position:fixed;bottom:16px;right:16px}.SKLogo{position:absolute;top:-200px;width:600px;opacity:0;animation-name:FadeIn;animation-duration:.6s;animation-fill-mode:forwards;animation-timing-function:ease-out}@media (min-width:60em){.SKLogo{top:-180px}}sk-button{margin-top:20px;opacity:0;animation-name:FadeIn;animation-duration:.4s;animation-delay:.7s;animation-fill-mode:forwards;animation-timing-function:ease-out}.UpdateReadyAlert{position:absolute;left:30px;bottom:30px}"
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SkButton; });
/* harmony import */ var _polymer_polymer_polymer_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @polymer/polymer/polymer-element */ "./node_modules/@polymer/polymer/polymer-element.js");
/* harmony import */ var _style_pcss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.pcss */ "./src/components/dumbs/sk-button/style.pcss");
/* harmony import */ var _style_pcss__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_style_pcss__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _template_html__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./template.html */ "./src/components/dumbs/sk-button/template.html");
/* harmony import */ var _template_html__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_template_html__WEBPACK_IMPORTED_MODULE_2__);



class SkButton extends _polymer_polymer_polymer_element__WEBPACK_IMPORTED_MODULE_0__["PolymerElement"] {
  static get template() {
    return Object(_polymer_polymer_polymer_element__WEBPACK_IMPORTED_MODULE_0__["html"])([`<style>${_style_pcss__WEBPACK_IMPORTED_MODULE_1___default.a}</style> ${_template_html__WEBPACK_IMPORTED_MODULE_2___default.a}`]);
  }
...
module.exports = ":host{display:inline-flex;background-image:linear-gradient(46deg,#ff00b0,#ff3b6a 94%);border-radius:100px;padding:8px 48px;font-weight:600;font-size:18px;cursor:pointer}"
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _polymer_polymer_lib_elements_dom_if__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @polymer/polymer/lib/elements/dom-if */ "./node_modules/@polymer/polymer/lib/elements/dom-if.js");
/* harmony import */ var _components_containers_sk_app__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/containers/sk-app */ "./src/components/containers/sk-app/index.js");
/* harmony import */ var _sw_loader__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./sw-loader */ "./src/sw-loader.js");
...
Object(_sw_loader__WEBPACK_IMPORTED_MODULE_2__["default"])();
